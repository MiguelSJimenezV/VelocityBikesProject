...
$productos = new Productos();
  ...
  if ($productos->agregarProducto($nombre, $marca, $anio_lanzamiento, $descripcion, $descripcion_larga, $material, $talle_disponible, $color_disponible, $cantidad_disponible, $imagen, $categoria, $precio)) {
